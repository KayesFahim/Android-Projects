...
import com.kayeswap.shahajjo.Services.BloodBank.BloodRequestModel;
...
public class RequestForPlasma extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.request_plasma);
    ...
    private void addRequest() {
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference("PlasmaRequest");
        ...
        if (!TextUtils.isEmpty(nm) && !TextUtils.isEmpty(phone) && !TextUtils.isEmpty(location)
            ...
            Intent intent = new Intent(RequestForPlasma.this, RequestPlasma.class);
   ...
   public void PushNot(String pblood){
       ...
       Intent resultIntent = new Intent(this, RequestForPlasma.class);
       ...
       PendingIntent resultPendingIntent =
        ...
        NotificationCompat.Builder mbuilder = new NotificationCompat.Builder(this, CHANNEL_ID)
                ...
                .setContentTitle(pblood+" Plasma Needed")
                .setContentText("You Can save a life donating your plasma")
                .setPriority(NotificationCompat.PRIORITY_DEFAULT)
                .setAutoCancel(true)
                .setGroup("com.kayeswap.shahajjo")
