...
public class AffectedCountries extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            NotificationChannel channel = new NotificationChannel("title", "Body", NotificationManager.IMPORTANCE_HIGH);
        ...
        FirebaseMessaging.getInstance().subscribeToTopic("Tracker").addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                String msg = "Succesfully";
                if(!task.isSuccessful()){
                    msg = "Failed";
                }
                Toast.makeText(AffectedCountries.this,msg,Toast.LENGTH_SHORT).show();
