...
public class CovidLabTestAdapter extends RecyclerView.Adapter<CovidLabTestAdapter.MyViewHolder> {
    FirebaseAuth mAuth;
    DatabaseReference mDatabase;

    Context context;
    ArrayList<CovidLabTestModel> model;

    public CovidLabTestAdapter(Context c, ArrayList<CovidLabTestModel> m) {
        context = c;
        model = m;
    }
    ...
    @NonNull
    @Override
    public CovidLabTestAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new CovidLabTestAdapter.MyViewHolder(LayoutInflater.from(context).inflate(R.layout.covid_labtest_view, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull final CovidLabTestAdapter.MyViewHolder holder, final int pos) {
