...
import com.kayeswap.darkcoin.Result;
...
public class Level_10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AdBottom = findViewById(R.id.lv10ad);
        ...
        ans1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mInterstitialAd.isLoaded()) {
                    ...
                    startActivity(new Intent(Level_10.this, ErrorPage.class));
        ...
        Ans.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mInterstitialAd.isLoaded()) {
                    ...
                    startActivity(new Intent(Level_10.this, Result.class));
                    Level_10.this.finish();
                }
                mInterstitialAd.setAdListener(new AdListener() {
                    @Override
                    public void onAdClosed() {
